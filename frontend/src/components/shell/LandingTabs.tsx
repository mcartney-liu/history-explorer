...
type TabKey = 'mine' | 'understand' | 'research' | 'expand'
...
const TABS: { key: TabKey; label: string; desc: string }[] = [
  { key: 'mine', label: '我的', desc: '你的探索足迹与研究' },
  { key: 'understand', label: '了解', desc: '浏览主题库：唐朝、科举制、造纸术…' },
  { key: 'research', label: '研究', desc: '提问式探索：就事实追问「为什么……」' },
]

export function LandingTabs({ mine, understand, research, expand, activeTab, onTabChange }: LandingTabsProps) {
